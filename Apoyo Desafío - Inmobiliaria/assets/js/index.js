...
function setCounter(parametro){
let counter= document.querySelector("#counter").innerHTML= parametro;
}
...
function filterProperties() {
  ...
  let filteredproperties= propiedadesJSON.filter(
    (propiedad) =>
      propiedad.rooms == roomInput &&
      propiedad.m >= fromInput &&
      propiedad.m <= toInput
  );
  sectionCard.innerHTML = "";
...
function validateInput(parametro) {
  if (
    parametro !== undefined &&
    parametro !== null &&
    parametro !== "" &&
